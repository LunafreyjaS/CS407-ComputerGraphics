...
class World {
    ...
    constructor(container) {
        ...
        //Create shapes
        const parachuteShape = new Parachute();
        const kiwiShape = createKiwi();

        kiwiShape.position.set(0, 0, -5);
    ...
    rotateParachute(direction) {
        ...
        if(direction == "left"){
            ...
            parachuteShape.rotation.set(rotationX, rotationY, 0);
        }
